...
const defaultAppState: AppState = {
  ...
  profile: {
    displayName: "Lukas",
    title: "Captain of Flow",
    aura: "Spokojna energia, szybkie decyzje i nacisk na domykanie rzeczy.",
    accent: "#66d7ff",
    avatar: "LX",
    badge: "Founders Pass",
    bio: "Buduje portal AI, questy i mini-gry z klimatem premium gaming-social.",
    clan: "Aurora Collective",
    statusLine: "Online now // polishing worlds",
    tags: ["strategy", "builder", "social UX"],
  },
  theme: {
    themeName: "Pulse Rift",
    heroTitle: "Jedno AI.\nWiele swiatow.\nZero martwych ekranow.",
    heroSubtitle:
      "Portal laczy chat, gry, rewardy, profil i studio administracyjne w jedno plynne doswiadczenie.",
    notice:
      "Kazdy ekran ma czuc sie jak fragment jednej premium aplikacji, a nie osobny prototyp.",
    accentFrom: "#67d8ff",
    accentTo: "#ffba6b",
    badgeText: "Season 02 // Live build",
    seasonLabel: "Aurora Season",
  },
  chatStyle: "nebula",
  journalEntries: [
    {
...
function buildDerivedState(state: AppState): DerivedState {
  ...
  const missions = [
    ...
    },
    {
      id: "mission-journal",
      title: "Quiet journal",
      detail: "Dodaj przynajmniej 3 wpisy, aby odblokowac dluższa sciezke refleksji.",
